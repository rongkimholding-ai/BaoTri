...
class MaintenanceSystemCompletedMail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Yêu cầu bảo trì hạ tầng đã được hỗ trợ',
            cc: $cc
        );
    }
    ...
    {
        return new Content(
            view: 'emails.maintenance-system-completed',
            with: [
